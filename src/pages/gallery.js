...
const Gallery = (  ) => {
  ...
  <Layout>
    ...
    <div className="py-6 px-6 sm:px-8 bg-gray-100">
      <header>
      <h1 className="flex flex-col items-center">
        ...
        <h1 className="mt-2 mb-8 font-extrabold tracking-tight text-gray-99 lg:text-4xl sm:text-3xl text-2xl">Galería de Imagenes</h1>
