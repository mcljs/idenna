...
<StaticImage
  ...
  src="https://pbs.twimg.com/profile_images/1037101550571806722/zYacZcEJ_400x400.jpg"
                  ...
                  <div className="sm:p-8 p-0 sm:mt-0 mt-4 text-center">
                    <h1 className="font-bold text-xl dark:text-white">Wilmer Vásquez Mateus</h1>
     ...
     <Link to="https://twitter.com/wilmervasquezm?lang=es"> 
                      <button
                        className="mt-4 px-3 py-2 rounded-md bg-gray-200 cursor-pointer inline-flex items-center dark:bg-[#132035]"
                        type="button"
                      >
                      <svg class="mr-1 text-[#1d9bf0]" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><g fill="currentColor"><path fill="none" d="M0 0h24v24H0z"></path><path d="M22.162 5.656a8.384 8.384 0 0 1-2.402.658A4.196 4.196 0 0 0 21.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 0 0-7.126 3.814 11.874 11.874 0 0 1-8.62-4.37 4.168 4.168 0 0 0-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 0 1-1.894-.523v.052a4.185 4.185 0 0 0 3.355 4.101 4.21 4.21 0 0 1-1.89.072A4.185 4.185 0 0 0 7.97 16.65a8.394 8.394 0 0 1-6.191 1.732 11.83 11.83 0 0 0 6.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.496 8.496 0 0 0 2.087-2.165z"></path></g></svg> <span className="dark:text-white">Twitter</span>                      </button>
                      </Link>
                  </div>               
              </li>
     ...
     <li className="overflow-hidden rounden-lg flex flex-col items-center">
                ...
                <StaticImage
                  ...
                  <div className="sm:p-8 p-0 sm:mt-0 mt-4 text-center">
                    <h1 className="font-bold text-xl dark:text-white">Josué Alejandro Lorca Vega</h1>
